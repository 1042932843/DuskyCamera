package com.lib.camera2.camera;
...
import com.lib.camera2.R;
import com.lib.camera2.utils.Camera2Util;
import com.lib.camera2.utils.LibPermission;
...
public class Camera2RecordActivity extends AppCompatActivity implements TextureView.SurfaceTextureListener {
    ...
    private CircularProgressView mProgressView;//录像进度条
    ...
    private void setUpMediaRecorder() {
        try {
            Log.e("dusky", "setUpMediaRecorder");
    ...
    private void prepareMediaRecorder() {
        ...
        try {
            closePreviewSession();
            Log.e("dusky", "prepareMediaRecorder");
            setUpMediaRecorder();
    ...
    private void startMediaRecorder() {
        Log.e("dusky", "startMediaRecorder");
        // Start recording
        try {
    ...
    Runnable recordRunnable = new Runnable() {
        ...
        public void run() {
            ...
            int progerss=Integer.parseInt((currentTime*100/MAX_RECORD_TIME)+"");
            Log.d(TAG, "dusky_run: currentTime"+currentTime+"/MAX_RECORD_TIME"+MAX_RECORD_TIME+"/progerss"+progerss);
            mProgressView.setProgress(progerss);
            //如果超过最大录制时长则自动结束
    ...
    protected void onStart() {
        super.onStart();
        LibPermission.checkPermission(this);
    }
    ...
    protected void onResume() {
        ...
        //每次开启预览缩放重置为正常状态
        if(LibPermission.isPermissionGranted(this)){
            if (zoom != null) {
                zoom.setEmpty();
                zoom_level = 0;
            }
